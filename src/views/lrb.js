...
import LrbTableContent from '../components/tableGroup/lrbTableContent';
...
class BalanceSheet extends React.Component {
  ...
  downLoad () { // 下载;
    ...
    $http('POST', {
      ...
      setTimeout(() => {
        window.open(encodeURI(this.state.host + data.data.url + '?constomFilename=利润表&deleteFileFlag=1'))
      }, 500)
    });
  }
        ...
        <div className="tab-pane" id="zcfz">
          ...
          <div className="m-t-md m-b-lg" style={{ minHeight: "505px", border: "1px solid #c3c3c3" }}>
            ...
            <RightTable tableData={ this.state.tableData }>
              <LrbTableContent tableListData={ this.state.tableData } />
            </RightTable>
          </div>
        </div>
